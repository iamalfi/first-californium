...
router.post("/users",auth.authenticate,auth.authorise ,userController.createUser)
router.post("/login",auth.authenticate,auth.authorise , userController.loginUser)
